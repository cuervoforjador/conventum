...
export class extendLorePosition extends ItemSheet {
  ...
  static get defaultOptions() {
    ...
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: [game.system.id, "sheet", "lorePosition", "golden", "_sheetDialog"],
      template: CONFIG._root+"/templates/lorePosition.html",
      width: 600,
      height: 650,
      tabs: [
   ...
   */
   async getData() {
    ...
    context.backend = await helperBackend.getBackend(context, 'lorePosition');
