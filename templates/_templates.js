export const preloadTemplates = async function() {
  ...
  return loadTemplates({
    ...
    */
    ...
    actorEquipmentBooks: CONFIG._root+"/templates/fragments/actor/equipment/actor_equipment_books.html",
    actorEquipmentHoldings: CONFIG._root+"/templates/fragments/actor/equipment/actor_equipment_holdings.html",
    actorEquipmentEconomy: CONFIG._root+"/templates/fragments/actor/equipment/actor_equipment_economy.html",
    ...
    itemHeader: CONFIG._root+"/templates/fragments/items/itemHeader.html",
